...
class DataExporter:
    ...
    def export_geo_nested_csv(self):
        ...
        with Pool(processes=4) as pool:
            # Using imap instead of map to handle updates correctly with tqdm
            r = list(tqdm(pool.imap_unordered(self._export_geo_data, tasks), total=len(tasks), desc="Processing GeoIDs"))
